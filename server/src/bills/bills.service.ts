...
export class BillsService implements IBillsService {
  ...
  constructor(
    ...
    neoPurchaseService: NeoPurchaseService,
    ethPurchaseService: EthPurchaseService,
    wechatPayService: WechatPayService,
    nearPurchaseService: NearPurchaseService,
    @InjectRepository(Bill) private readonly billRepo: Repository<Bill>,
  ) {
    this.purchaseChannels = {
      eth: ethPurchaseService,
      neo: neoPurchaseService,
      wechat: wechatPayService,
      near: nearPurchaseService,
    };
  }
  ...
  private convertJobDataChannelType(
    ...
    const map: Record<ChannelPurchasedJobData['channel'], PurchaseChannelId> = {
      eth: PurchaseChannelId.ETH,
      neo: PurchaseChannelId.NEO,
      wechat: PurchaseChannelId.WECHAT,
      near: PurchaseChannelId.NEAR,
    };
    return map[channel];
  }
}
